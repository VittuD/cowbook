...
Top-level `tools/` and `scripts/` are repository utilities, not part of the package runtime surface. Benchmark harnesses should stay there rather than under `src/cowbook`.
